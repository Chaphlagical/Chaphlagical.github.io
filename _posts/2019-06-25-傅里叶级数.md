...
$x(t)=\sqcap(\frac{t}{2T_1}) \ with\ period\ T_0 \longrightarrow X_k= \frac{2T_1}{T_0}Sinc(\frac{2kT_1}{T_0})$

$x(t)=\wedge(\frac{t}{T_1})\ with \ period \ T_0 \longrightarrow X_k=\frac{T_1}{T_0}Sinc^2(\frac{kT_1}{T_0})$

$x(t)=Ш(t)\longrightarrow X_k=1$
...
| Multiplication       | $x(t)h(t)\ \ (T_x=T_h)$                                    | $\sum\limits^{\infty}_{l=-\infty}X_lH_{k-l}$                 |
