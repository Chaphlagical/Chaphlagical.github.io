...
$\begin{cases}X(f)=\int^\infin_{-\infin}x(t)e^{-j2\pi ft}dt \\\\ x(t)=\int^\infin_{-\infin} X(f)e^{j2\pi ft} df\end{cases}$
...
| Integration                  | $\int^t _{-\infin} x(\tau)d\tau$                  | $\frac{X(f)}{j2\pi f}+\frac{1}{2}X(0)\delta(f)$ |
| Complex Conjugate            | $x^*(t)$                                          | $X^*(-f)$                                       |
| Differentiation in Frequency | $tx(t)$                                           | $-\frac{1}{j2\pi}\frac{dX(f)}{df}$              |
| Integration in Frequency     | $\frac{x(t)}{-j2\pi t}+\frac{1}{2} \delta(t)x(0)$ | $\int^f_{-\infin} X(f')df'$                     |

**Parseval Relation: ** $\int^{\infin}_{-\infin} |x(t)|^2dt=\int^{\infin}_{-\infin}|X(f)|^2df$
...
$FS\rightarrow FT: X(f)=\sum\limits^\infin_{-\infin} X_k\delta(f-kf_0)$
