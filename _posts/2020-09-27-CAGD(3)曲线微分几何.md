...
计算机辅助几何设计学习笔记第二章，内容包括曲线微分几何的基础知识
...
* 归一化向量$\pmb t=\dfrac{\pmb c'}{\vert c'\vert}$称为**正切向量**
...
* 对于正则曲线
	...
	* 正切向量：$\pmb t=\dfrac{\pmb c'}{\vert\vert\pmb c'\vert\vert}$，法平面：$(\pmb p-\pmb p_0)\cdot\pmb t=0$
